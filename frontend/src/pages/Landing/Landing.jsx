    ...
    <main className="landing-page">
      ...
      <section className="roles-section">
        ...
        <div className="roles-container">
          <div className="role-card">
            ...
            <p>
              Post real-world problems, connect with talented problem solvers,
              and review innovative solutions built for your challenge.
            </p>
          ...
          <div className="role-card solver-card">
            ...
            <p>
              Explore meaningful challenges, use AI-powered guidance, and submit
              your work directly to problem owners.
            </p>
      ...
      <section className="ai-section">
        <div className="ai-container">
          <div className="ai-content">
            ...
            <p>
              SolveSphere uses AI to understand problem statements and guide
              problem solvers with relevant suggestions, approaches, and
              technology ideas.
            </p>
      ...
      <section className="cta-section">
        <div className="cta-content">
          ...
          <p>
            Join SolveSphere and start solving meaningful real-world problems
            today.
          </p>
